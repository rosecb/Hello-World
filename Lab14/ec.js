...
<input type="submit" value="Submit" id="submit">
 ...
 app.post("/register", function (request, response) {
    ...
    // gives error messige if username or password has a flaw in it
    request.query.LoginError = error;
    // login form sticker so the user does not have to re-enter their information
    request.query.StickyLoginUser = users_reg_data[username].username;
